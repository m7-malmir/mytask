...
{
    public class SEObjectiveBr : BusinessRule<SEObjectiveKeyViewModel,
                                            ...
                                            SEObjectiveFullViewModel>
    {
        ...
        public SEObjectiveBr(Serilog.ILogger logger, byte currentCompanyId, string currentUserId, IDbConnection? dbConnection) : base(logger, currentCompanyId, currentUserId, dbConnection)
        {
            _logger = logger;
        ...
        //********************************************************************************************************************
        //public override SysResult AddPrecondition(SEObjectiveViewModel viewModel)
        //{
        //    var sEObjectiveBc = new SEObjectiveBc(_logger, _currentCompanyId, _currentUserId, _dbConnection);
        //    var predicate = "ObjectiveId = @UnitId and UserId = @UserId";
        ...
        //    var result = sEObjectiveBc.Select(predicate, predicateParameters);
        ...
        //    var objectiveResultViewModels = (IEnumerable<SEObjectiveResultViewModel>)result.Value;

        //    if (objectiveResultViewModels.Any())
        //    {
