...
$("#group_cost_grid-body").on("input", function(eve) {
 ...
 var rowCount = $("#group_cost_grid").getNumberRows();
    ...
    if (myarray.length >= 7) {
        ...
        if (myarray == "12") {
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(29); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#BEF0CB");
           
          } else if (myarray == "17") {
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(30); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#BEF0CB");
            
          } else if (myarray == "19") {
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(20); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#BEF0CB");
            
          } else if (myarray == "15") {
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(16); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#BEF0CB");
           
          } else if (myarray == "18") {
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(18); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#BEF0CB");
            
          } else if (myarray == "16") {
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(26); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#BEF0CB");
            
          } else if (myarray == "14") {
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(28); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#BEF0CB");
            
          } else if (myarray == "21") {
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(32); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#BEF0CB");
            
          } else if (myarray == "20") {
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(10); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#BEF0CB");
      
            
          } else if (myarray == "57") {
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(7); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#BEF0CB");
      
            
          } else if (myarray == "54") {
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(6); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#BEF0CB");
      
            
          } else if (myarray == "55") {
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(1); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#BEF0CB");
      
            
          } else if (myarray == "13") {
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(14); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#BEF0CB");
      
            
          } else if (myarray == "61") {
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(19); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#BEF0CB");
      
            
          } else if (myarray == "51") {
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(9); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#BEF0CB");
      
            
          } else if (myarray == "62") {
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(5); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#BEF0CB");
      
            
          } else if (myarray == "58") {
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(17); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#BEF0CB");
      
            
          } else if (myarray == "56") {
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(15); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#BEF0CB");
            ...
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(21); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#BEF0CB");
      
            
          } else if (myarray == "53") {
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(25); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#BEF0CB");
      
            
          } else if (myarray == "78") {
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(12); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#BEF0CB");
      
            
          } else if (myarray == "70") {
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(22); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#BEF0CB");
           
          }
          else {
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").val(''); 
            $("#group_cost_grid-body select[id='form[group_cost_grid]["+i+"][g2_banks_list]']").css("background-color", "#fff");
