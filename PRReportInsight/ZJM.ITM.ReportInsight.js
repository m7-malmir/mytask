...
$(function () {
  tblMain = (function () {
    // ====================== Variables ======================
    const pageSize = 10;
    const readRows = FormManager.readReportInsight;
    let currentSort = {
      Column: "Id",
      Direction: "DESC",
    };
...
//#region tscReportInsight_Delete
$("#tscReportInsight_Add").click(function () {
  $.showModalForm(
    {
      registerKey: "ZJM.ITM.ReportInsightRegulate",
...
//#endregion tscReportInsight_Add.js
...
$("#tscReportInsight_Edit").click(function () {
  ...
  $.showModalForm(
    {
      registerKey: "ZJM.ITM.ReportInsightRegulate",
      params: { ReportInsightId: id, currentUserId: CurrentUserId },
    },
    function (retVal) {
      tblMain.refresh();
    }
...
//#endregion tscReportInsight_Edit.js

//#region tscReportInsight_Refresh
$("#tscReportInsight_Delete").click(function () {
  // ====================== Variables ======================
...
const FormManager = (() => {
    ...
    // ====== getValidViewModels ======
    function getValidViewModels(requestParams, onError) {
        var items = (requestParams && requestParams.viewModels) ? requestParams.viewModels : [];
        if (!items.length) {
            handleError("deleteUnit", "No valid [viewModels] were provided for deletion.", onError);
            return [];
        }
	...
	return {
        ...
        deleteReportInsightList(jsonParams, onSuccess, onError) {
            ...
            $.ajax({
                ...
                error: function (xhr, status, error) {
                    handleError("deleteReportInsightList", `Error in deletion request: ${status} - ${error}`, onError);
                }
            });
        }
	};
